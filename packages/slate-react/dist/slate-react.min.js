(function (global, factory) {
  ...
  (global = global || self, factory(global.SlateReact = {}, global.React, global.Slate));
  ...
  const Leaf$1 = (props) => {
      ...
      let children = (React__default.createElement(String$1, { isLast: isLast, leaf: leaf, parent: parent, text: text }));
      ...
      function (_Editor) {
        ...
        createClass(ReactEditor, [{
          ...
          value: function getDecorations(node) {
            ...
            if (placeholder && slate.Value.isValue(node) && node.children.length === 1 && Array.from(slate.Node.texts(node)).length === 1 && slate.Node.text(node) === '') {
