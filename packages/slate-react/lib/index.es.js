...
import React, { createContext, useContext, useRef, useLayoutEffect, useMemo, useCallback } from 'react';
import scrollIntoView from 'scroll-into-view-if-needed';
import isPlainObject$1 from 'is-plain-object';
...
(function (Element) {
  ...
  Element.isElement = function (value) {
    return isPlainObject$1(value) && Node$1.isNodeList(value.children) && !Value.isValue(value);
  };
  /**
...
(function (Value) {
  ...
  Value.isValue = function (value) {
    return isPlainObject$1(value) && (value.selection === null || Range.isRange(value.selection)) && Node$1.isNodeList(value.children) && Range.isRangeMap(value.annotations);
  };
  /**
        ...
        case 'insert_node':
          {
            var _path = op.path,
                _node = op.node;
            var parent = Node$1.parent(v, _path);
        ...
        case 'insert_text':
          {
            ...
            var _node2 = Node$1.leaf(v, _path2);
        ...
        case 'merge_node':
          {
            ...
            var _node3 = Node$1.get(v, _path3);

            var prevPath = Path.previous(_path3);
            var prev = Node$1.get(v, prevPath);

            var _parent = Node$1.parent(v, _path3);
        ...
        case 'move_node':
          {
            ...
            var _node4 = Node$1.get(v, _path4);

            var _parent2 = Node$1.parent(v, _path4);
            ...
            var newParent = Node$1.get(v, Path.parent(truePath));
        ...
        case 'remove_mark':
          {
            ...
            var _node5 = Node$1.leaf(v, _path5);
        ...
        case 'remove_node':
          {
            ...
            var _parent3 = Node$1.parent(v, _path6);

            var _Node$texts = Node$1.texts(v, {
              from: _path6,
              reverse: true
            }),
            ...
            var _Node$texts3 = Node$1.texts(v, {
              from: _path6
            }),
        ...
        case 'remove_text':
          {
            ...
            var _node6 = Node$1.leaf(v, _path7);
        ...
        case 'set_mark':
          {
            ...
            var _node7 = Node$1.leaf(v, _path8);
        ...
        case 'set_node':
          {
            ...
            var _node8 = Node$1.get(v, _path9);
        ...
        case 'split_node':
          {
            ...
            var _node9 = Node$1.get(v, _path10);

            var _parent4 = Node$1.parent(v, _path10);
  ...
  createClass(DeletingCommands, [{
    ...
    value: function insertFragment(fragment) {
      ...
      this.withoutNormalizing(function () {
        ...
        try {
          for (var _iterator = Node$1.nodes({
            children: fragment
          }, {
            pass: matcher
  ...
  createClass(NodeCommands, [{
    ...
    value: function mergeNodes() {
      ...
      this.withoutNormalizing(function () {
        ...
        var emptyAncestor = Node$1.furthest(_this3.value, path, function (_ref9) {
...
function () {
  ...
  createClass(GeneralCommands, [{
    ...
    value: function normalize() {
      ...
      if (force) {
        var allPaths = Array.from(Node$1.nodes(this.value), function (_ref3) {
          var _ref4 = slicedToArray(_ref3, 2),
              p = _ref4[1];
    ...
    case 'insert_node':
      {
        ...
        var descendants = Text.isText(node) ? [] : Array.from(Node$1.nodes(node), function (_ref5) {
          var _ref6 = slicedToArray(_ref5, 2),
              p = _ref6[1];
...
function () {
  ...
  createClass(LocationQueries, [{
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              return _context2.delegateYield(Node$1.elements(this.value, _objectSpread$5({}, options, {
                from: from,
                to: to,
                pass: function pass(_ref) {
    ...
    value: function getAncestor(at) {
      ...
      var ancestor = Node$1.get(this.value, ancestorPath);
    ...
    value: function getFragment(at) {
      ...
      var fragment = Node$1.fragment(this.value, range);
      return fragment;
    }
    /**
    ...
    value: function getLeaf(at) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var path = this.getPath(at, options);
      var node = Node$1.leaf(this.value, path);
      return [node, path];
    }
    /**
    ...
    value: function getNode(at) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var path = this.getPath(at, options);
      var node = Node$1.get(this.value, path);
      return [node, path];
    }
    /**
    ...
    value: function getPath(at) {
      ...
      if (Path.isPath(at)) {
        if (edge === 'start') {
          var _Node$first = Node$1.first(this.value, at),
              _Node$first2 = slicedToArray(_Node$first, 2),
              firstPath = _Node$first2[1];

          at = firstPath;
        } else if (edge === 'end') {
          var _Node$last = Node$1.last(this.value, at),
              _Node$last2 = slicedToArray(_Node$last, 2),
    ...
    value: function getPoint(at) {
      ...
      if (Path.isPath(at)) {
        ...
        if (edge === 'end') {
          var _Node$last3 = Node$1.last(this.value, at),
              _Node$last4 = slicedToArray(_Node$last3, 2),
              lastPath = _Node$last4[1];

          path = lastPath;
        } else {
          var _Node$first3 = Node$1.first(this.value, at),
    ...
    value: function hasNode(at) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var path = this.getPath(at, options);
      var exists = Node$1.has(this.value, path);
      return exists;
    }
    /**
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _iteratorError9 = undefined;
              _context3.prev = 9;
              _iterator9 = Node$1.levels(this.value, path)[Symbol.iterator]();
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              return _context4.delegateYield(Node$1.marks(this.value, _objectSpread$5({}, options, {
                from: from,
                to: to,
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              iterable = Node$1.nodes(this.value, _objectSpread$5({}, options, {
                from: from,
                to: to,
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 4:
              ...
              return _context8.delegateYield(Node$1.texts(this.value, _objectSpread$5({}, options, {
                from: from,
                to: to,
  ...
  createClass(NodeQueries, [{
    ...
    value: function isNodeMatch(entry, match) {
      ...
      if (typeof match === 'function') {
        ...
        return Node$1.matches(node, match);
      }
    }
  }]);
...
var normalizeDOMPoint = function normalizeDOMPoint(domPoint) {
  var _domPoint = slicedToArray$1(domPoint, 2),
      node = _domPoint[0],
...
(function (Utils) {
  ...
  Utils.setFragmentData = function (dataTransfer, editor) {
    ...
    var _SlateRange$edges = Range.edges(selection),
        _SlateRange$edges2 = slicedToArray$1(_SlateRange$edges, 2),
    ...
    if (endVoid) {
      var _endVoid = slicedToArray$1(endVoid, 1),
          voidNode = _endVoid[0];
    ...
    var fragment = Node$1.fragment(value, selection);
...
const String = (props) => {
    ...
    if (editor.isVoid(parent)) {
        return React.createElement(ZeroWidthString, { length: Node$1.text(parent).length });
    }
...
(function (Leaf) {
  ...
  Leaf.isLeaf = function (value) {
    return isPlainObject$1(value) && typeof value.text === 'string' && Mark.isMarkSet(value.marks) && Range.isRangeList(value.decorations) && Range.isRangeMap(value.annotations);
  };
  /**
  ...
  Leaf.split = function (leaf, offset) {
    return [{
      ...
      marks: leaf.marks,
      annotations: _objectSpread$6({}, leaf.annotations),
      decorations: toConsumableArray$1(leaf.decorations)
    }, {
 ...
 */
const Leaf$1 = (props) => {
    const { leaf, isLast, text, parent, renderAnnotation = (props) => (React.createElement(CustomAnnotation, Object.assign({}, props))), renderDecoration = (props) => (React.createElement(CustomDecoration, Object.assign({}, props))), renderMark = (props) => React.createElement(CustomMark, Object.assign({}, props)), } = props;
    ...
    return React.createElement("span", { "data-slate-leaf": true }, children);
};
const MemoizedLeaf = React.memo(Leaf$1, (prev, next) => {
...
const Text$1 = (props) => {
    ...
    for (let i = 0; i < leaves.length; i++) {
        const leaf = leaves[i];
        children.push(React.createElement(MemoizedLeaf, { isLast: isLast && i === leaves.length - 1, key: `${key.id}-${i}`, leaf: leaf, text: text, parent: parent, renderAnnotation: renderAnnotation, renderDecoration: renderDecoration, renderMark: renderMark }));
    }
...
const MemoizedText = React.memo(Text$1, (prev, next) => {
...
const Element$1 = (props) => {
    const { annotations, decorate, decorations, element, renderAnnotation, renderDecoration, renderElement = (p) => React.createElement(CustomElement, Object.assign({}, p)), renderMark, selection, } = props;
    const ref = useRef(null);
    const editor = useEditor();
    const readOnly = useReadOnly();
    const isInline = editor.isInline(element);
    const key = editor.findKey(element);
    let children = (React.createElement(Children, { annotations: annotations, decorate: decorate, decorations: decorations, node: element, renderAnnotation: renderAnnotation, renderDecoration: renderDecoration, renderElement: renderElement, renderMark: renderMark, selection: selection }));
    ...
    if (!isInline && editor.hasInlines(element)) {
        const text = Node$1.text(element);
    ...
    if (editor.isVoid(element)) {
        ...
        children = readOnly ? null : (React.createElement(Tag, { "data-slate-spacer": true, style: {
            ...
            React.createElement(MemoizedText, { annotations: {}, decorations: [], isLast: false, parent: element, text: text })));
...
const MemoizedElement = React.memo(Element$1, (prev, next) => {
...
const Children = (props) => {
    ...
    const children = [];
    const isLeafBlock = Element.isElement(node) && !editor.isInline(node) && editor.hasInlines(node);
    for (let i = 0; i < node.children.length; i++) {
        ...
        if (Element.isElement(n)) {
            children.push(React.createElement(MemoizedElement, { annotations: anns, decorate: decorate, decorations: decs, element: n, key: key.id, renderAnnotation: renderAnnotation, renderDecoration: renderDecoration, renderElement: renderElement, renderMark: renderMark, selection: sel }));
        }
        else {
            children.push(React.createElement(MemoizedText, { annotations: anns, decorations: decs, key: key.id, isLast: isLeafBlock && i === node.children.length, parent: node, renderAnnotation: renderAnnotation, renderDecoration: renderDecoration, renderMark: renderMark, text: n }));
        }
...
const Editor$1 = (props) => {
    const { decorate = defaultDecorate, editor, value, onChange, placeholder, readOnly = false, renderAnnotation, renderDecoration, renderElement, renderMark, style = {}, ...attributes } = props;
    ...
    return (React.createElement(EditorContext.Provider, { value: editor },
        React.createElement(ReadOnlyContext.Provider, { value: readOnly },
            React.createElement(FocusedContext.Provider, { value: editor.isFocused() },
                React.createElement("div", Object.assign({ "data-gramm": false, role: readOnly ? undefined : 'textbox' }, attributes, { 
                    ...
                    React.createElement(Children, { annotations: value.annotations, decorate: decorate, decorations: decorate([value, []]), node: value, renderAnnotation: renderAnnotation, renderDecoration: renderDecoration, renderElement: renderElement, renderMark: renderMark, selection: value.selection }))))));
};
/**
    ...
    function (_Editor) {
      ...
      createClass$1(ReactEditor, [{
        ...
        value: function apply(op) {
          ...
          get$2(getPrototypeOf(ReactEditor.prototype), "apply", this).call(this, op);

          for (var _i = 0, _matches = matches; _i < _matches.length; _i++) {
            var _matches$_i = slicedToArray$1(_matches[_i], 2),
        ...
        value: function getDecorations(node) {
          ...
          if (placeholder && Value.isValue(node) && node.children.length === 1 && Array.from(Node$1.texts(node)).length === 1 && Node$1.text(node) === '') {
            var _decorations$push;

            var start = this.getStart([]);
            decorations.push((_decorations$push = {}, defineProperty$1(_decorations$push, PLACEHOLDER_SYMBOL, true), defineProperty$1(_decorations$push, "placeholder", placeholder), defineProperty$1(_decorations$push, "anchor", start), defineProperty$1(_decorations$push, "focus", start), _decorations$push));
          }
        ...
        key: "handleInput",
        value: function handleInput(type, data, range) {
        ...
        value: function toDomNode(node) {
          var domNode = Value.isValue(node) ? EDITOR_TO_ELEMENT.get(this) : KEY_TO_ELEMENT.get(this.findKey(node));
        ...
        value: function toDomPoint(point) {
          var _this$getNode3 = this.getNode(point.path),
              _this$getNode4 = slicedToArray$1(_this$getNode3, 1),
        ...
        value: function toDomRange(range) {
          ...
          var domFocus = Range.isCollapsed(range) ? domAnchor : this.toDomPoint(focus);
        ...
        value: function toSlatePoint(domPoint) {
          var _normalizeDOMPoint = normalizeDOMPoint(domPoint),
              _normalizeDOMPoint2 = slicedToArray$1(_normalizeDOMPoint, 2),
...
export { Editor$1 as Editable, Editor$1 as Editor, useEditor, useFocused, useReadOnly, useSelected, useSlate, withReact };
