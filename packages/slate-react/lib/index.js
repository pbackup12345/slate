...
const String = (props) => {
    ...
    if (editor.isVoid(parent)) {
        return React__default.createElement(ZeroWidthString, { length: Node$1.text(parent).length });
    }
...
const MemoizedText = React__default.memo(Text$1, (prev, next) => {
...
const Element$1 = (props) => {
    const { annotations, decorate, decorations, element, renderAnnotation, renderDecoration, renderElement = (p) => React__default.createElement(CustomElement, Object.assign({}, p)), renderMark, selection, } = props;
    const ref = React.useRef(null);
    const editor = useEditor();
...
const MemoizedElement = React__default.memo(Element$1, (prev, next) => {
...
const Children = (props) => {
    ...
    for (let i = 0; i < node.children.length; i++) {
        ...
        if (Element.isElement(n)) {
            ...
            children.push(React__default.createElement(MemoizedText, { annotations: anns, decorations: decs, key: key.id, isLast: isLeafBlock && i === node.children.length, parent: node, renderAnnotation: renderAnnotation, renderDecoration: renderDecoration, renderMark: renderMark, text: n }));
        }
    ...
    return (React__default.createElement(EditorContext.Provider, { value: editor },
        React__default.createElement(ReadOnlyContext.Provider, { value: readOnly },
            React__default.createElement(FocusedContext.Provider, { value: editor.isFocused() },
                React__default.createElement("div", Object.assign({ "data-gramm": false, role: readOnly ? undefined : 'textbox' }, attributes, { 
