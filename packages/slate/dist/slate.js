(function (global, factory) {
  ...
  (function (Element) {
    ...
    Element.isElement = function (value) {
      return isPlainObject$1(value) && exports.Node.isNodeList(value.children) && !exports.Value.isValue(value);
    };
    /**
  ...
  (function (Node) {
    ...
    Node.first = function (root, path) {
      ...
      while (n) {
        if (exports.Text.isText(n) || n.children.length === 0) {
          break;
        } else {
          n = n.children[0];
          p.push(0);
    ...
    Node.get = function (root, path) {
      ...
      for (var i = 0; i < path.length; i++) {
        ...
        if (exports.Text.isText(node) || !node.children[p]) {
      ...
      return regenerator.wrap(function nodes$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 12:
              if (!(!visited.has(n) && !exports.Text.isText(n) && n.children.length !== 0 && (pass == null || pass([n, p]) === false))) {
                _context6.next = 19;
                break;
              }
  ...
  (function (Operation) {
    ...
    Operation.isOperation = function (value) {
      ...
      switch (value.type) {
        ...
        case 'merge_node':
          {
            return typeof value.position === 'number' && (typeof value.target === 'number' || value.target === null) && exports.Path.isPath(value.path) && isPlainObject$1(value.properties);
          }
        ...
        case 'set_mark':
          {
            return exports.Path.isPath(value.path) && isPlainObject$1(value.properties) && isPlainObject$1(value.newProperties);
          }
        ...
        case 'split_node':
          {
            return exports.Path.isPath(value.path) && typeof value.position === 'number' && (typeof value.target === 'number' || value.target === null) && isPlainObject$1(value.properties);
          }
  ...
  (function (Point) {
    ...
    Point.isPoint = function (value) {
      return isPlainObject$1(value) && typeof value.offset === 'number' && exports.Path.isPath(value.path);
    };
    /**
          ...
          case 'split_node':
            {
              if (exports.Path.equals(op.path, path)) {
                if (op.position === offset && affinity == null) {
                  ...
                  p.offset -= op.position;
                  p.path = exports.Path.transform(path, op, _objectSpread$1({}, options, {
                    affinity: 'forward'
                  }));
                }
              } else {
  ...
  (function (Range) {
    ...
    Range.isRange = function (value) {
      return isPlainObject$1(value) && exports.Point.isPoint(value.anchor) && exports.Point.isPoint(value.focus);
    };
    /**
  ...
  (function (Value) {
    ...
    Value.isValue = function (value) {
      return isPlainObject$1(value) && (value.selection === null || exports.Range.isRange(value.selection)) && exports.Node.isNodeList(value.children) && exports.Range.isRangeMap(value.annotations);
    };
    /**
    ...
    createClass(DeletingCommands, [{
      ...
      value: function insertFragment(fragment) {
        ...
        this.withoutNormalizing(function () {
          ...
          if (!at) {
            return;
          } else if (exports.Range.isRange(at)) {
            if (!hanging) {
          ...
          } else if (exports.Path.isPath(at)) {
          ...
          var _Node$first = exports.Node.first({
            children: fragment
          }, []),
              _Node$first2 = slicedToArray(_Node$first, 2),
              firstPath = _Node$first2[1];

          var _Node$last = exports.Node.last({
            children: fragment
          }, []),
          ...
          var matcher = function matcher(_ref5) {
            ...
            if (mergeStart && exports.Path.isAncestor(p, firstPath) && exports.Element.isElement(n) && !_this2.isVoid(n) && !_this2.isInline(n)) {
              return false;
            }

            if (mergeEnd && exports.Path.isAncestor(p, lastPath) && exports.Element.isElement(n) && !_this2.isVoid(n) && !_this2.isInline(n)) {
              return false;
            }
          ...
          try {
            for (var _iterator = exports.Node.nodes({
              children: fragment
            }, {
              pass: matcher
          ...
          for (var _i2 = 0, _matches = matches; _i2 < _matches.length; _i2++) {
            ...
            if (exports.Element.isElement(node) && !_this2.isInline(node)) {
              starting = false;
              hasBlocks = true;
              middles.push(node);
            } else if (starting) {
          ...
          var middleRef = _this2.createPathRef(isBlockEnd ? exports.Path.next(blockPath) : blockPath);

          var endRef = _this2.createPathRef(isInlineEnd ? exports.Path.next(inlinePath) : inlinePath);
          ...
          var startRef = _this2.createPathRef(!isInlineStart || isInlineStart && isInlineEnd ? exports.Path.next(inlinePath) : inlinePath);
          ...
          if (!options.at) {
            ...
            if (ends.length > 0) {
              path = exports.Path.previous(endRef.current);
            } else if (middles.length > 0) {
              path = exports.Path.previous(middleRef.current);
            } else {
              path = exports.Path.previous(startRef.current);
            }
    ...
    createClass(NodeCommands, [{
        ...
        this.withoutNormalizing(function () {
          ...
          if (match == null) {
            if (exports.Path.isPath(at)) {
              ...
              match = function match(_ref) {
                ...
                return exports.Path.equals(p, path);
              };
          ...
          if (exports.Point.isPoint(at)) {
            ...
            if (atMatch) {
              ...
              at = isAtEnd ? exports.Path.next(_path) : _path;
            } else {
              return;
            }
          }
      ...
      value: function liftNodes() {
        ...
        this.withoutNormalizing(function () {
          ...
          for (var _i = 0, _pathRefs = pathRefs; _i < _pathRefs.length; _i++) {
            ...
            var _this2$getNode = _this2.getNode(exports.Path.parent(_path3)),
      ...
      value: function mergeNodes() {
        ...
        this.withoutNormalizing(function () {
          ...
          if (match == null) {
            if (exports.Path.isPath(at)) {
              ...
              match = function match(_ref7) {
                ...
                return exports.Path.equals(p, _path4);
              };
            } else {
              match = 'block';
            }
          ...
          var emptyAncestor = exports.Node.furthest(_this3.value, path, function (_ref9) {
            var _ref10 = slicedToArray(_ref9, 2),
                n = _ref10[0],
                p = _ref10[1];

            return exports.Path.isDescendant(p, commonPath) && exports.Path.isAncestor(p, path) && exports.Element.isElement(n) && n.children.length === 1;
          });
      ...
      value: function normalizeNodes(options) {
        ...
        if (exports.Element.isElement(node) && node.children.length === 0) {
          var child = {
            text: '',
            marks: []
          };
        ...
        var shouldHaveInlines = exports.Value.isValue(node) ? false : exports.Element.isElement(node) && (this.isInline(node) || node.children.length === 0 || exports.Text.isText(node.children[0]) || this.isInline(node.children[0])); // Since we'll be applying operations while iterating, keep track of an
        ...
        for (var i = 0; i < node.children.length; i++, n++) {
          ...
          var isInlineOrText = exports.Text.isText(_child) || exports.Element.isElement(_child) && this.isInline(_child); // Only allow block nodes in the top-level value and parent blocks that
        ...
        this.withoutNormalizing(function () {
          ...
          try {
            for (var _iterator3 = _this7.levels({
              ...
              if (_path8.length < highestPath.length || _path8.length === 0 || exports.Element.isElement(node) && _this7.isVoid(node)) {
                break;
              }
      ...
      value: function apply(op) {
        ...
        try {
          for (var _iterator4 = oldDirtyPaths[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            var newPath = exports.Path.transform(path, op);
            add(newPath);
          }
        } catch (err) {
          _didIteratorError4 = true;
      ...
      case 'move_node':
        {
          ...
          try {
            for (var _iterator6 = exports.Path.ancestors(_path4)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
              ...
              var p = exports.Path.transform(ancestor, op);
              oldAncestors.push(p);
            }
          } catch (err) {
            _didIteratorError6 = true;
          ...
          try {
            for (var _iterator7 = exports.Path.ancestors(newPath)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              ...
              var _p = exports.Path.transform(_ancestor, op);
      ...
      case 'remove_node':
        {
          ...
          var _ancestors = exports.Path.ancestors(_path5);
      ...
      case 'split_node':
        {
          ...
          var _levels = exports.Path.levels(_path6);

          var nextPath = exports.Path.next(_path6);
  ...
  function () {
    ...
    createClass(ElementQueries, [{
      ...
      value: function isEmpty(element) {
        ...
        return children.length === 0 || children.length === 1 && exports.Text.isText(first) && first.text === '' && !this.isVoid(element);
      }
      /**
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                return _context2.delegateYield(exports.Node.elements(this.value, _objectSpread$5({}, options, {
                  from: from,
                  to: to,
                  pass: function pass(_ref) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                ...
                return _context4.delegateYield(exports.Node.marks(this.value, _objectSpread$5({}, options, {
                  from: from,
                  to: to,
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                ...
                iterable = exports.Node.nodes(this.value, _objectSpread$5({}, options, {
                  from: from,
                  to: to,
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 4:
                ...
                return _context8.delegateYield(exports.Node.texts(this.value, _objectSpread$5({}, options, {
                  from: from,
                  to: to,
    ...
    createClass(NodeQueries, [{
      ...
      value: function isNodeMatch(entry, match) {
        ...
        switch (match) {
          ...
          case 'element':
            return exports.Element.isElement(node);

          case 'inline':
            return exports.Element.isElement(node) && this.isInline(node) || exports.Text.isText(node);

          case 'inline-element':
            return exports.Element.isElement(node) && this.isInline(node);

          case 'block':
            return exports.Element.isElement(node) && !this.isInline(node) && this.hasInlines(node);

          case 'void':
            return exports.Element.isElement(node) && this.isVoid(node);
        }
