...
(function (Element) {
  ...
  Element.isElement = function (value) {
    return isPlainObject(value) && exports.Node.isNodeList(value.children) && !exports.Value.isValue(value);
  };
  /**
...
(function (Value) {
  ...
  Value.isValue = function (value) {
    return isPlainObject(value) && (value.selection === null || exports.Range.isRange(value.selection)) && exports.Node.isNodeList(value.children) && exports.Range.isRangeMap(value.annotations);
  };
  /**
