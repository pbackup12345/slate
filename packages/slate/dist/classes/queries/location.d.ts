import { AncestorEntry, AnnotationEntry, Editor, ElementEntry, Location, Mark, MarkEntry, NodeEntry, NodeMatch, Path, Point, Range, Span, TextEntry } from '../..';
...
declare class LocationQueries {
     ...
     */
    getMatch(this: Editor, at: Location, match: NodeMatch): NodeEntry | undefined;
    /**
     ...
     */
    getPrevious(this: Editor, at: Location, match: NodeMatch): NodeEntry | undefined;
    /**
