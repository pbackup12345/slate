...
function () {
  function PointRef(props) {
    classCallCheck$1(this, PointRef);
...
function () {
  function RangeRef(props) {
    classCallCheck$1(this, RangeRef);
...
function () {
  function AnnotationCommands() {
    classCallCheck$1(this, AnnotationCommands);
  }

  createClass$1(AnnotationCommands, [{
    key: "addAnnotation",
...
function () {
  function DeletingCommands() {
    classCallCheck$1(this, DeletingCommands);
  }

  createClass$1(DeletingCommands, [{
    key: "delete",
...
function () {
  function NodeCommands() {
    classCallCheck$1(this, NodeCommands);
  }

  createClass$1(NodeCommands, [{
    key: "insertNodes",
...
function () {
  function MarkCommands() {
    classCallCheck$1(this, MarkCommands);
  }

  createClass$1(MarkCommands, [{
    key: "addMarks",
...
function () {
  function SelectionCommands() {
    classCallCheck$1(this, SelectionCommands);
  }

  createClass$1(SelectionCommands, [{
    key: "collapse",
...
function () {
  function GeneralCommands() {
    classCallCheck$1(this, GeneralCommands);
  }

  createClass$1(GeneralCommands, [{
    key: "apply",
...
function () {
  function ElementQueries() {
    classCallCheck$1(this, ElementQueries);
  }

  createClass$1(ElementQueries, [{
    key: "hasBlocks",
...
function () {
  function GeneralQueries() {
    classCallCheck$1(this, GeneralQueries);
  }

  createClass$1(GeneralQueries, [{
    key: "createPathRef",
...
function () {
  function LocationQueries() {
    classCallCheck$1(this, LocationQueries);
  }

  createClass$1(LocationQueries, [{
    key: "annotations",
...
function () {
  function NodeQueries() {
    classCallCheck$1(this, NodeQueries);
  }

  createClass$1(NodeQueries, [{
    key: "isNodeMatch",
...
function () {
  function RangeQueries() {
    classCallCheck$1(this, RangeQueries);
  }

  createClass$1(RangeQueries, [{
    key: "unhangRange",
  ...
  if (editor.isNodeMatch(entry, rule.match)) {
    ...
    if ('marks' in v && v.marks != null) {
      ...
      try {
        ...
        for (var _iterator = Node.marks(node)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _ret = _loop();
...
var checkParent = function checkParent(editor, entry, index, rule, childRule) {
  ...
  var child = Node.child(parent, index);
  ...
  if ('previous' in cv && cv.previous != null && index > 0 && editor.isNodeMatch([child, childPath], rule.match)) {
    var prevChild = Node.child(parent, index - 1);
  ...
  if ('next' in cv && cv.next != null && index < parent.children.length - 1 && editor.isNodeMatch([child, childPath], rule.match)) {
    var nextChild = Node.child(parent, index + 1);
